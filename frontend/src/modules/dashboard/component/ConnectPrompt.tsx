  ...
  return (
    <div className="flex min-h-[78vh] flex-col items-center justify-center gap-7 px-4 text-center">
      ...
      <div className="overflow-hidden pb-1">
        <h1 className="animate-[tends-rise_0.6s_cubic-bezier(0.22,1,0.36,1)] max-w-2xl font-sans text-3xl font-bold leading-[1.05] tracking-[-0.03em] text-ink motion-reduce:animate-none sm:text-5xl">
