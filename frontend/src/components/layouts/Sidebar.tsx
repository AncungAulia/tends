    ...
    >
      ...
      <div className="flex flex-col gap-2 pt-3">
        <div className={`flex flex-col gap-2 ${collapsed ? "" : "px-1"}`}>
          {authenticated ? (
            <div
              className={`group relative flex items-center gap-2 rounded-lg py-1 transition-colors hover:bg-card ${
              ...
              {collapsed ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md text-dim transition-colors hover:bg-panel hover:text-red-500"
                  >
                    <LogOut size={13} />
                  </button>
                </>
            ...
            !collapsed && (
              <button
                onClick={() => login()}
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-brand px-3 py-2 text-sm font-medium text-white transition-colors hover:opacity-90"
              >
                <Wallet size={15} />
                Connect Wallet
              </button>
