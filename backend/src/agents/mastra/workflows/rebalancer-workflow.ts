...
// GitHub Models gpt-4o — bypasses the Hermes gateway (hardcoded copilot/gpt-4o, 429-prone).
const strategyModel = createOpenAICompatible({
  name: "github-models",
  baseURL: env.ACTION_AGENT_BASE_URL,
  apiKey: env.GITHUB_TOKEN,
}).chatModel(env.REBALANCER_AGENT_MODEL);
